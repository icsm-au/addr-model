...
|*Version* |
*1.1.1*: 2026-03 Fix class examples & update validator +
...
|*Copyright* | &copy; The State of Queensland (Department of Natural Resources and Mines, Manufacturing, and Regional and Rural Development) 2020-2023, Intergovernmental Committee on Surveying & Mapping, 2026
